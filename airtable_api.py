...
latest_jobs = [row for row in all if row['fields']['creation_date'] > data['creation_date']]
...
for job in latest_jobs[::-1]:
    post_data = {
        ...
        "kind": "link",
        "sr": SUBREDDIT,
        "url": job['fields']['job_detail_url'] + "?utm_source=reddit&utm_medium=bot",
        "resubmit": "true",
        "api_type": "json",
        "sendreplies": "true",
...
if job:
    ...
    latest_posted = {'id': job['id'],
                    'creation_date': job['fields']['creation_date']}
